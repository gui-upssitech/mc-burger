...
public class TestEcranCuisinierMiTextuelle {
	public static void main(String[] args) {
		...
		// Initialisation vue du cas commander & cas Inclus/etendu
		...
		BoundaryCommander boundaryCommander = new BoundaryCommander(controlCommande,
				boundaryEnregistrerCoordonneesBancaires);

		// cas visualisation commande du jour
		ControlVisualiserCommandeJour cVisualisationCommandeJour = new ControlVisualiserCommandeJour(
